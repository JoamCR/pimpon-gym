      ...
      {monthDays.map((d) => {
        ...
        return (
          <div 
            ...
            className={`min-h-28 rounded-md p-2 border ${isCurrentMonth ? 'bg-[var(--color-card-alt)]' : 'bg-[var(--color-card)] opacity-50'} border-[var(--color-border)] cursor-pointer hover:bg-[rgba(255,255,255,0.02)] transition-colors flex flex-col`}
          >
            ...
            <div className="space-y-1 overflow-y-auto flex-1 max-h-36 scrollbar-thin">
